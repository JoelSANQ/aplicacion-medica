    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
            ...
            child: InkWell(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const ProfilePage(), // <- tu otro widget
                  ),
                );
              },
              child: Container(
          ...
          ElevatedButton.icon(
            onPressed: () => noImpl('Consejos de salud'),
...
// Si aún no tienes esta página, deja este placeholder o ajusta el import
